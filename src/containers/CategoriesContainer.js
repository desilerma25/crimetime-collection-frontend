    ...
    render() {
        return (
            <div className='cat_cont'>
                <h6>Please allow a moment for the categories to display as Heroku enjoys taking naps if the site is not active. If it takes a tad too long please open this site on another tab or refresh the page.</h6>
                <Switch>
